...
export function apiGatewayEvent(override: NestedPartial<ExtendedAPIGatewayEvent> = {}): ExtendedAPIGatewayEvent {
  console.warn(`Creating a mock API Gateway event by calling 'apiGatewayEvent()' has been deprecated and will be removed in a future release - use 'new ApiGatewayEvent()' instead`);
