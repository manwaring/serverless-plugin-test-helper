...
/*
 * @deprecated This method has been deprecated and will be removed in the next major release, use `new ApiGatewayEvent()` instead
 */
export function apiGatewayEvent(override: NestedPartial<ExtendedAPIGatewayEvent> = {}): ExtendedAPIGatewayEvent {
  // console.warn(
  //   "This method has been deprecated and will be removed in the next major release, use `new ApiGatewayEvent()` instead"
  // );
...
export class ApiGatewayEvent {
  ...
  constructor(override: NestedPartial<ExtendedAPIGatewayEvent> = {}) {
    const extended = all([defaultEvent, override]) as ExtendedAPIGatewayEvent;
